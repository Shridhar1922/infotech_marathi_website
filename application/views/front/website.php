...
<section class="bg-half-170 pt-30px pb-0 d-table w-100 main-banner" style="background: url(<?= site_url('assets/front_commonarea/'); ?>img/chat-background.jpg)">
    <div class="container">
        <!-- TEXT -->
        <div class="text-center p-2">
            <p style="color: #495057;font-family: 'Sahitya', serif;">
                Scrollup provides authentic Magazine in Marathi, Marathi Digital Magazine, Marathi News on WhatsApp, Free digital newspaper & Free digital magazine.
            </p>
        </div> <!-- ends -->
        <div class="row justify-content-center align-items-center text-center">
            <div class="col-lg-7">
                    ...
                    <h3 class="heading mb-2">
                        <span class="sublines"><span class="font-laila-bold">आता तुमच्या</span>
                            <span class="font-martel-sans-black" style="color: #25d366">
                                <img src="<?= site_url('assets/front_commonarea/'); ?>img/walogo.png" class="logowa" alt="" />WhatsApp</span>
                            <span class="font-laila-bold">वर मिळवा</span></span>
                    </h3>

                    <div class="morphing">
                        <?php $count_heading = 0; ?>
                        <?php if (!empty($home[0]['animated_heading_1'])) { ?><div class="word" style="animation-delay: -4s; -webkit-animation-delay: -4s;">
                                <?php echo !empty($home[0]['animated_heading_1']) ? $home[0]['animated_heading_1'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                } ?>
                        <?php if (!empty($home[0]['animated_heading_2'])) { ?><div class="word" style="animation-delay: -6s; -webkit-animation-delay: -6s">
                                <?php echo !empty($home[0]['animated_heading_2']) ? $home[0]['animated_heading_2'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                } ?>
                        <?php if (!empty($home[0]['animated_heading_3'])) { ?><div class="word" style="animation-delay: -8s; -webkit-animation-delay: -8s">
                                <?php echo !empty($home[0]['animated_heading_3']) ? $home[0]['animated_heading_3'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                } ?>
                        <?php if (!empty($home[0]['animated_heading_4'])) { ?><div class="word" style="animation-delay: -10s; -webkit-animation-delay: -10s">
                                <?php echo !empty($home[0]['animated_heading_4']) ? $home[0]['animated_heading_4'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                }  ?>
                        <?php if (!empty($home[0]['animated_heading_5'])) { ?><div class="word" style="animation-delay: -12s; -webkit-animation-delay: -12s">
                                <?php echo !empty($home[0]['animated_heading_5']) ? $home[0]['animated_heading_5'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                }  ?>
                        <?php if (!empty($home[0]['animated_heading_6'])) { ?><div class="word" style="animation-delay: -14s; -webkit-animation-delay: -14s">
                                <?php echo !empty($home[0]['animated_heading_6']) ? $home[0]['animated_heading_6'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                }  ?>
                        <?php if (!empty($home[0]['animated_heading_7'])) { ?><div class="word" style="animation-delay: -16s; -webkit-animation-delay: -16s">
                                <?php echo !empty($home[0]['animated_heading_7']) ? $home[0]['animated_heading_7'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                }  ?>
                        <?php if (!empty($home[0]['animated_heading_8'])) { ?><div class="word" style="animation-delay: -18s;-webkit-animation-delay: -18s">
                                <?php echo !empty($home[0]['animated_heading_8']) ? $home[0]['animated_heading_8'] : ''; ?>
                            </div><?php } else {
                                    $count_heading = $count_heading + 1;
                                }  ?>
                        <?php if (!empty($home[0]['animated_heading_9'])) { ?><div class="word" style="animation-delay: -20s; -webkit-animation-delay: -20s">
                ...
                <div class="stats">
                    ...
                    <a href="<?= site_url('view-registered-users') ?>" target="_blank" type="button" style="font-family: 'laila', serif;" class="btn btn-primary btn-sm"> View</a>
                </div>
            </div>
            <div class="col-lg-5 cus-mob-pad" style="padding: 40px 20px">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12 mt-sm-0">
                            <div class="form-group mb-4" style="margin-bottom: 32px !important;">
                                ...
                                <input type="hidden" name="txtpkey" id="txtpkey" value="<?php echo !empty($register_user[0]['user_id']) ? $register_user[0]['user_id'] : ''; ?>">
                                <input type="tel" onkeyup="this.value=this.value.replace(/[^\d]/,'')" class="form-control font-sahitya-bold isInteger" name="mobile_number" maxlength="10" minlength="10" placeholder="तुमचा 10 अंकी WhatsApp क्रमांक" id="mobile_number" />
                        ...
                        <div id="alert" class="font-laila-bold form-heading no-pad">
                            <p> Your Number Is Registered <a href="" class="link_url" id="goto_link_click">Click Here To Save Number</a>.</p>
                        </div>
                        ...
                        <?php if (!empty($get_num)) { ?>
                            <div class="col-md-12 mt-sm-0">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 mt-sm-0 no-pad" id="resend_otp" style="padding-top: 10px; padding-bottom: 15px; text-align: right;">
                                    ...
                                    <div class="otp-wrapper otp-event">
                                        <div class="col-md-12 mt-sm-0 no-pad">
                                            <button type="button" class="btn btn-primary btn-block p font-sahitya-bold otp-submit otp" style="margin-bottom: 1.5rem;margin-top: 1.5rem;">Get Otp</button>
                                        </div>
                                        <div class="otp-container" id="otp_session">
                                            <input type="tel" id="value_1" class="otp-number-input" maxlength="1" autocomplete="off">
                                            <input type="tel" id="value_2" class="otp-number-input" maxlength="1" autocomplete="off">
                                            <input type="tel" id="value_3" class="otp-number-input" maxlength="1" autocomplete="off">
                                            <input type="tel" id="value_4" class="otp-number-input" maxlength="1" autocomplete="off">
                                            <input type="tel" id="value_5" class="otp-number-input" maxlength="1" autocomplete="off">
                                            <input type="tel" id="value_6" class="otp-number-input" maxlength="1" autocomplete="off">
                                        </div>
                                        <label id="error-otp" class="error"></label>

                                        <div class="col-md-12 mt-sm-0 no-pad" id="verify">
                                            <button id="confirm" type="button" class="btn btn-primary btn-block p font-sahitya-bold otp-submit" style="margin-bottom: 1.5rem;margin-top: 1.5rem;"><span class="verify_text_loader">Verify</span> <i class="fa fa-spinner fa-spin btn_loader_verify"></i></button>
                                        </div>
                            ...
                            <?php } ?>
                            <div class="col-md-12 mt-sm-0">
                                <button type="button" id="join_on" class="btn btn-primary btn-block btn-block p font-sahitya-bold submit" style="margin-bottom: 2rem;" data-datac="form"><span class="button_text_loader"><i class="fa fa-user-plus"></i>
                                        <?php echo !empty($home[0]['button_1']) ? $home[0]['button_1'] : '' ?></span> <i class="fa fa-spinner fa-spin btn_loader_view"></i>
                                </button>
                            </div>
                            <?php if (!empty($get_num)) { ?>
                                <div class="col-md-12 mt-sm-0 no-pad">
                                <?php } else { ?>
                                    <div class="col-md-12 mt-sm-0">
                                    <?php } ?>
                                    <button type="button" id="btnredirect" class="btn btn-primary btn-block p font-sahitya-bold btn_click">
                                        <?php echo !empty($home[0]['button_2']) ? $home[0]['button_2'] : '' ?>
                                    </button>
                                    </div>
                                    <input type="hidden" id="referral_name" value="<?php echo !empty($get_referral_user_data[0]['name']) ? $get_referral_user_data[0]['name'] : ''; ?>">
                                    <input type="hidden" id="referral_city_id" value="<?php echo !empty($get_city_tb_name[0]['city_id']) ? $get_city_tb_name[0]['city_id'] : ''; ?>">
                                    <input type="hidden" id="referral_tb_name" value="<?php echo !empty($get_city_tb_name[0]['sql_tb_name']) ? $get_city_tb_name[0]['sql_tb_name'] : ''; ?>">
                                    <input type="hidden" id="referral_user_id" value="<?php echo !empty($get_referral_user_data[0]['user_id']) ? $get_referral_user_data[0]['user_id'] : ''; ?>">
                                    <input type="hidden" id="referral_by" value="<?php echo !empty($get_num) ? $get_num : ''; ?>">
                                </div>
                            </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="success-img text-center">
                                                    <img src="<?= site_url('assets/front_commonarea/'); ?>img/success.gif" class="modal_img_animation" width="80px" />
                                                </div>
                                                ...
                                                <div class="sub-btn text-center">
                                                    <a href="" id="cus_btn_close" data-datac="model" class="btn btn-primary cus-btn-success link"> OK </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    <img src="<?php echo base_url(); ?><?php echo !empty($home[0]['banner']) ? $home[0]['banner'] : 'assets/commonarea/dist/img/default.png'; ?>" style="width: 100%" />
                </div>
