...
<head>
  ...
  <title><?php echo !empty($cms_data[0]['cms_meta_title']) ? $cms_data[0]['cms_meta_title'] : 'Scrollup | Digital Newspaper' ?></title>
...
FREE त्यासाठी लगेच जॉईन करा 👉 Scrollup Digital Magazine 👈'; ?>">
  <meta name="keywords" content="<?php echo !empty($cms_data[0]['cms_meta_keywords']) ? $cms_data[0]['cms_meta_keywords'] : 'magazine in marathi, marathi magazine, digital magazine whatsapp,marathi news on whatsapp, whatsapp digital magazine, marathi digital magazine on whatsapp whatsapp magazine, free digital magazine whatsapp marathi, marathi digital magazine'; ?>">
  <meta name="msvalidate.01" content="886EBFE9AD0C33CFC5DDDB0E7888FEFA" />
  <link rel="icon" href="<?php echo base_url(); ?><?php echo !empty($visualSettings[0]['favicon']) ? $visualSettings[0]['favicon'] : 'assets/front_commonarea/img/scrollup_crop.png'; ?>" type="image/png" sizes="16x16">
...
FREE त्यासाठी लगेच जॉईन करा 👉 Scrollup Digital Magazine 👈 ">
  ...
  <meta property="og:image" content="<?php echo base_url(); ?><?php echo !empty($visualSettings[0]['favicon']) ? $visualSettings[0]['favicon'] : 'assets/front_commonarea/img/scrollup_crop.png'; ?>">
...
FREE त्यासाठी लगेच जॉईन करा 👉 Scrollup Digital Magazine 👈">
  <meta name="twitter:image" content="<?php echo base_url(); ?><?php echo !empty($visualSettings[0]['favicon']) ? $visualSettings[0]['favicon'] : 'assets/front_commonarea/img/scrollup_crop.png'; ?>">
