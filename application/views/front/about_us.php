...
<section id="mobile-lang">
    <div class="radio_btn">
        <label class="radio-inline"><input type="radio" class="radioBtnClass" value="Marathi" name="optradio" id="marathi" checked>मराठी</label>
        <label class="radio-inline"><input type="radio" class="radioBtnClass" value="English" name="optradio">English</label>
    </div>
</section>
...
<header class="sticky">
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            ...
            <div class="language">
                <label label class="radio-inline"><input type="radio" value="Marathi" class="radioBtnClass" name="optradio" checked>मराठी</label>
                <label class="radio-inline"><input type="radio" value="English" class="radioBtnClass" name="optradio">English</label>
            </div>
...
<div id="english_content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12  my-4">
                    <h4 class="py-4 text-center">Welcome to Scrollup Digital Magazine</h4>
                    ...
                    <ul style="padding: 0px" class="ul-eng">
                        ...
                        <li>
                            <p> ScrollUp is a digital social network that provides you with a
    ...
    <section id="icon-boxes" class="p-4 content-english">
        ...
        <h4 class="text-center py-4">
            Scrollup launched through WhatsApp - This Marathi Digital Magazine provides
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <!-- <img src="" alt=""> -->
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/News.gif" class="" />

                            <h3>News</h3>
                            <p>
                                Scrollup Digital Magazine on WhatsApp will give you important news
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/job_update.gif" class="" />
                            <h3>Job Updates</h3>
                            <p>
                                Accurate information on all job or employment opportunities for
                                children in rural and urban areas will be given on scrollup
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Competetive_Exam.gif" class="" />
                            <h3>Competitive Examination</h3>
                            <p>
                                Important documents and information about all types of competitive
                                exams will give you scrollup on WhatsApp in simple language and
                                fastest.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Government_Sceme.gif" class="" />
                            <h3>Government Scheme</h3>
                            <p>
                                People in rural areas use WhatsApp but they don't get enough
                                information about government schemes. Scrollup gives them
            ...
            <div class="row mb-4">
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Motivation_thought.gif" class="" />
                            <h3>Inspirational Ideas</h3>
                            <p>
                                Marathi Status will give a scrollup on WhatsApp that will create
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Entertainment.gif" class="" />
                            <h3>Entertainment</h3>
                            <p>
                                Fun stories from the daily stress the articles that will make you
                                happy to read will be given on the scrollup.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/crime.gif" class="" />
                            <h3>Crime</h3>
                            <p>
                                Illegal Behavior or Crime in Maharashtra will give you a scrollup
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Horoscope.gif" class="" />
                            <h3>Horoscope</h3>
                            <p>
                                Scrollup will help you to see your position in the twelve zodiac
            ...
            <div class="row mb-4">
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/local_update.gif" class="" />
                            <h3>Local Update</h3>
                            <p>
                                Scrollup Digital Updates on your WhatsApp will give you the news
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Self_Business_Guide.gif" class="" />
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Sport.gif" class="" />
                            <h3>Games</h3>
                            <p>
                                Scrollup will provide you with important sports information and
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Politics.gif" class="" />
                            <h3>Politics</h3>
                            <p>
                                Scrollup WhatsApp Magazine on WhatsApp will give you a Free
            ...
            <div class="row mb-4">
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Technology.gif" class="" />
                            <h3>Technology</h3>
                            <p>
                                Scrollup technology will give you in-depth information on when
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Agriculture.gif" class="" />

                            <h3>Agricultural Guidance</h3>
                            <p>
                                Use of modern technology, research and development of agriculture
                                in a new way will now make every farmer scrollup magazine
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/Quality_Article.gif" class="" />
                            <h3>Quality Articles</h3>
                            <p>
                                An article that will definitely fill your mind after reading will
                                give you scrollup on Marathi magazine WhatsApp.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 ">
                    <div class="card bg-info text-center">
                        <div class="card-body">
                            <img src="<?= site_url('assets/front_commonarea/'); ?>/img/about-us-images/health.gif" class="" />
                            <h3>Health</h3>
                            <p>
...
<div id="marathi_content">
            ...
            <div class="row">
                <div class="col-md-12  my-4">
                    <h4 class="py-4 text-center">
                        नमस्कार स्क्रोलअप या डिजिटल मॅगझीन मध्ये आपला स्वागत आहे
                    </h4>
                    ...
                    <ul style="padding:0;" class="ul-marathi">
                        ...
                        <li>
                            <p>
                                स्क्रोलअप हे एक डिजिटल सोशल नेटवर्क आहे ज्यावर बातम्यांचं
                        ...
                        <li>
                            <p>
                                ...
                                देण्यासाठी स्क्रोल अप टीम ने व्हाट्सअप्प वर सेवा देण्यास सुरुवात
                                केली.
                            </p>
                        </li>
                    </ul>
    ...
    <section id="icon-boxes" class="p-4 content-marathi">
        <!-- <h2 class="py-3 text-center">Our Services</h2> -->
        <h4 class="text-center py-4">
            व्हॉटस्अपच्या माध्यमातून सुरू झालेले स्क्रोलअप - हे मराठी डिजीटल मॅगझीन
            खालील सेवा पुरवते :
        </h4>
        <div class="container">
            <div class="row mb-4">
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                दोन मिनिटात वाचून होतील अश्या बातम्या व्हाट्सअप वर स्क्रोलअप
                                डिजिटल मॅगझीन देईल
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                सर्व संधीची अचुक माहिती स्क्रोलअप वर दिली जाईल
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                सोप्या भाषेत व सर्वात जलद व्हाट्सअप वर तुम्हाला स्क्रोलअप देईल .
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                माहिती पुरेशी भेटत नाही त्यांना स्क्रोलअप थेट मराठीमध्ये माहिती
                                देते .
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                आवडतील अशे मराठी स्टेटस व्हाट्सअप वर स्क्रोलअप देईल.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                आनंद भेटेल अशे लेख स्क्रोलअप वर दिले जातील .
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                अभ्यासपूर्ण लिहून तुम्हाला व्हाट्सअप्प वर स्क्रोलअप न्युजपेपर देईल
                                .
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                होईल, हे बारा राशीमध्ये तुमचा अंदाज पाहण्यास स्क्रोलअप मदत करेल .
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <h3>लोकल अपडेट</h3>
                            <p>
                                तुमच्या जिल्ह्यातील बातम्या तुमच्या व्हाट्सअप्प वर स्क्रोल्अप
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                विस्तार सुनिश्चित करन्यासाठी उद्योग मार्गदर्शन व मदत स्क्रोलअप
                                करेल .
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                खेळाबद्दल बातम्या असतील ते स्क्रोलअप तुम्हाला व्हाट्सअप डिजिटल
                                मॅगझीन वर देईल .
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                राजकारणाच्या सूत्रांच्या हालचाली तुम्हाला व्हाट्सअप्प वर स्क्रोलअप
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                विविध साधनांची निर्मिती केली जाते त्याची सखोल माहिती स्क्रोलअप
                    ...
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <p>
                                ...
                                प्रत्येक शेतकऱ्याला करणार स्क्रोलअप मॅगझीन कृषी मार्गदर्शन
                                व्हाट्सअप वर .
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <h3>दर्जेदार लेख</h3>
                            <p>
                                जे वाचल्यावर नक्कीच तुमचे मन भरून येईल अशे लेख तुम्हाला स्क्रोलअप
                ...
                <div class="col-md-3 ">
                    <div class="card bg-info text-white text-center">
                        <div class="card-body">
                            ...
                            <h3>आरोग्य</h3>
                            <p>
                                निरोगी आरोग्य ठेवण्यासाठी ज्ञान , नवीन आजार व त्यापासून प्रतिबंधित कसे राहायचे हे स्क्रोल अप माहिती व्हाट्सअप वर देईल.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row bottom-text">
                <div class="col-md-12  py-2">
                    <div class="container text-center">
                        ...
                        <p>
                            आम्हाला आशा आहे की तुम्ही आमच्या सेवेचा लाभ घ्याल. आपल्याकडे काही प्रश्न किंवा काही सुचवावे वाटले तर कृपया आमच्याशी संपर्क साधण्यास संकोच करू नका. </p>
                    </div>
                </div>
            </div>
        </div>
