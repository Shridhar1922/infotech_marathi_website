                    ...
                    <h1>Payment Transfer
                        <div class="pull-right">
                            <a href="<?= site_url('shubham/pending-payment-transfer') ?>">
                                <button type="button" class="btn btn-primary" id="" style="padding-right: 7px;">
...
<!-- <div id="view_pending_model" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    var table = $("#example").dataTable({
        ...
        "ajax": {
            url: "<?php echo base_url('get-data-table-pending-payment?' . $_SERVER['QUERY_STRING']) ?>",
            type: 'POST'
        },
    });
