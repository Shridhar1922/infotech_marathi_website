    ...
    <div class="login-box">
        ...
        <div class="login-box-body w3l-login-form ">
            ...
            <div class="login-form">
                ...
                <?php
        $attribute = array('role' => 'form', 'id' => 'sendMailForForgetPassword');
        echo form_open('send-mail-for-forget-password', $attribute); ?>
                ...
                <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <button type="submit" class="button submit">Send OTP</button>
                    </div>
                    <!-- /.col -->
                </div>
                <?php echo form_close(); ?>
