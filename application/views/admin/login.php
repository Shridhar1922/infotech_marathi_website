...
<body class="hold-transition login-page">
    ...
    <div class="login-form">
      ...
      <div class=" w3l-form-group">
        ...
        <div class="group">
          ...
          <input type="text" name="email" id="email" class="form-control" placeholder="Username" value="<?php echo (!empty($_COOKIE['email'])) ? $_COOKIE['email'] : ''; ?>" />
        </div>
      ...
      <div class=" w3l-form-group">
        ...
        <div class="group">
          ...
          <input type="password" name="password" id="password" class="form-control" placeholder="Password" value="<?php echo (!empty($_COOKIE['password'])) ? $_COOKIE['password'] : ''; ?>" />
          <span toggle="#password" class="fa fa-fw fa-eye-slash field-icon toggle-password password_eye_icon"></span>
        </div>
      </div>
      <div class="forgot">
        <a href="<?= site_url('shubham/forgot-password') ?>">Forgot Password?</a>
        <p><input type="checkbox" name="remember" value="yes" <?php echo (!empty($_COOKIE['email']) && !empty($_COOKIE['password'])) ? 'checked="" ' : ''; ?>>Remember Me</p>
      </div>
  ...
  <div class="msg_div">
    ...
    ?>
    <div class="err-msg2" style="position: fixed;right: 0px;bottom: 10px;z-index: 1; <?php echo (!empty($msg) ? 'display:block;' : 'display:none;'); ?>">
